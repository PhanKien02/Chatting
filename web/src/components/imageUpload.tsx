            ...
            <div className="relative" onClick={triggerFileSelect}>
                {
                    mode === "avatar" ?
                        <Avatar className="w-24 h-24 flex justify-center items-center border shadow">
                            ...
                            <AvatarFallback><User width={50} height={50} /></AvatarFallback>
                        </Avatar> : <div className="mx-auto flex cursor-pointer flex-col items-center justify-center gap-y-2 rounded-lg border border-foreground p-8 shadow-sm shadow-foreground w-140 h-140">
                            {
                ...
                <Button
                    size="icon"
                    variant="secondary"
                    className="absolute bottom-0 right-0 w-8 h-8 p-1 rounded-full"
                >
